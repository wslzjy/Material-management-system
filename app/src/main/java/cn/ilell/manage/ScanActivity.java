...
import cn.ilell.manage.scanner.AmbientLightManager;
import cn.ilell.manage.scanner.BeepManager;
import cn.ilell.manage.scanner.FinishListener;
import cn.ilell.manage.scanner.InactivityTimer;
import cn.ilell.manage.scanner.IntentSource;
import cn.ilell.manage.scanner.camera.CameraManager;
import cn.ilell.manage.scanner.common.BitmapUtils;
import cn.ilell.manage.scanner.decode.BitmapDecoder;
import cn.ilell.manage.scanner.decode.CaptureActivityHandler;
import cn.ilell.manage.scanner.view.ViewfinderView;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case PARSE_BARCODE_SUC: // 解析图片成功
                    Toast.makeText(activityReference.get(), "123" + msg.obj.toString(), Toast.LENGTH_SHORT).show();
                    //Intent mIntent = new Intent();
                    //mIntent.putExtra("describe", msg.obj.toString());
                    //activityReference.get().setResult(10004, mIntent);
                    //activityReference.get().finish();
//                    Map<String, String> params = new HashMap<String, String>();
//                    params.put("content", msg.obj.toString());
//                    params.put("homeid", BaseData.home_id);
//                    params.put("userid", BaseData.user_id);
//                    String result = HttpXmlClient.post("http://115.159.30.115/ihome/backdeal/DealScan.php", params);
//                    if (result.equals("success")) {
//                        Toast.makeText(activityReference.get(), "添加成功", Toast.LENGTH_SHORT).show();
//                    } else {
//                        Toast.makeText(activityReference.get(), result, Toast.LENGTH_SHORT).show();
//                    }
                    break;
...
//        viewfinderView.drawResultBitmap(barcode);
        ...
        Intent intent = new Intent(this, ShowScanMsgActivity.class);
        intent.putExtra("code", ResultParser.parseResult(rawResult).toString());
