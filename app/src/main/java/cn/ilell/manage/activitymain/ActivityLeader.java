...
import cn.ilell.manage.fragment.FragLeader0;
import cn.ilell.manage.fragment.FragLeader1;

/**
 * Created by WSL
 */
public class ActivityLeader extends BaseActivity {
    ...
    private void initData() {
        ...
        mTitles = getResources().getStringArray(R.array.frag0_tab_titles);
        ...
        FragLeader0 fragment = new FragLeader0();
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.nav_menu_bind_un:
                        changeActivity(ActivityUnBind.class);
                        break;
                    ...
                    case R.id.nav_menu_sys:
                        Intent i = new Intent(ActivityLeader.this, ScanActivity.class);
                        startActivity(i);
                        break;
