...
import cn.ilell.manage.fragment.FragPersonal;
...
public class ActivityPersonal extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = ActivityPersonal.this;
    ...
    private void initData() {
        ...
        mTitles = getResources().getStringArray(R.array.frag1_tab_titles);
        ...
        FragPersonal fragment = new FragPersonal();
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.nav_menu_sys:
                        Intent i = new Intent(ActivityPersonal.this, ScanActivity.class);
                        startActivity(i);
                        break;
