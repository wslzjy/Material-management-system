...
import cn.ilell.manage.fragment.FragBind;
...
public class ActivityBind extends BaseActivity {
    ...
    private void initData() {
        ...
        FragBind fragment = new FragBind();
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.nav_menu_sys:
                        Intent i = new Intent(ActivityBind.this, ScanActivity.class);
                        startActivity(i);
                        break;
