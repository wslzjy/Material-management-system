...
import cn.ilell.manage.fragment.FragShutdownInfo;
...
public class ActivityInfo extends BaseActivity {
    ...
    private void initData() {
        ...
        mTitles = getResources().getStringArray(R.array.frag6_tab_titles);
        ...
        FragShutdownInfo fragment = new FragShutdownInfo();
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.nav_menu_sys:
                        Intent i = new Intent(ActivityInfo.this, ScanActivity.class);
                        startActivity(i);
                        break;
