...
import cn.ilell.manage.fragment.FragPhoneNum;

/**
 * Created by WSL
 */
public class ActivityPhoneNum extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = ActivityPhoneNum.this;
    ...
    private void initData() {
        ...
        mTitles = getResources().getStringArray(R.array.frag4_tab_titles);
        ...
        FragPhoneNum fragment = new FragPhoneNum();
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.nav_menu_sys:
                        Intent i = new Intent(ActivityPhoneNum.this, ScanActivity.class);
                        startActivity(i);
                        break;
