...
import cn.ilell.manage.fragment.FragLowBattery;

/**
 * Created by WSL
 */
public class ActivityLowBattery extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = ActivityLowBattery.this;
    ...
    private void initData() {
        ...
        mTitles = getResources().getStringArray(R.array.frag5_tab_titles);
        ...
        FragLowBattery fragment = new FragLowBattery();
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.nav_menu_sys:
                        Intent i = new Intent(ActivityLowBattery.this, ScanActivity.class);
                        startActivity(i);
                        break;
